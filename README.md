...
| `/parallax-stress-test-thesis book.md` | Book mode — several theses in one run → per-thesis reports plus a cross-thesis concentration roll-up (where separate ideas secretly share a load-bearing assumption or break on the same trigger) |
